...
<div class="right">
  <div class="card">
    ...
    @if($errors->any())<div class="err-box">{{ $errors->first('username') }}</div>@endif
    <form method="POST" action="{{ route('login.post') }}">
      @csrf
      <div class="fg">
        <label>Username</label>
        <input type="text" name="username" value="{{ old('username') }}" placeholder="Masukkan username" autofocus autocomplete="username">
    ...
    <div class="foot">BrewLux POS &copy; {{ date('Y') }}</div>
  </div>
</div>
</body>
</html>
