...
<div class="card">
  ...
  <div class="tw">
    <table>
      <thead><tr><th>Foto</th><th>Nama Produk</th><th>Kategori</th><th>Harga</th><th>Stok</th><th>Status</th><th>Aksi</th></tr></thead>
      <tbody>
        ...
        @empty
        <tr><td colspan="7" style="text-align:center;color:var(--muted);padding:3rem">Tidak ada produk ditemukan</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
