...
<title><?php echo $__env->yieldContent('title','Dashboard'); ?> — BrewLux Admin</title>
...
<aside class="sb">
  ...
  <nav>
    ...
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.dashboard') ? 'on':''); ?>"><span class="ic">📊</span>Dashboard</a>
    <div class="nav-sec">Manajemen</div>
    <a href="<?php echo e(route('admin.products.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.products.*') ? 'on':''); ?>"><span class="ic">🍽️</span>Menu & Produk</a>
    <a href="<?php echo e(route('admin.categories.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.categories.*') ? 'on':''); ?>"><span class="ic">📂</span>Kategori</a>
    <div class="nav-sec">Laporan</div>
    <a href="<?php echo e(route('admin.transactions.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.transactions.*') ? 'on':''); ?>"><span class="ic">🧾</span>Jurnal Transaksi</a>
    <div class="nav-sec">Sistem</div>
    <a href="<?php echo e(route('admin.users.index')); ?>" class="nav-a <?php echo e(request()->routeIs('admin.users.*') ? 'on':''); ?>"><span class="ic">👥</span>Kelola User</a>
  </nav>
  <div class="sb-foot">
    <div class="sb-usr">
      <div class="sb-av"><?php echo e(strtoupper(substr(auth()->user()->nama_lengkap ?? auth()->user()->username,0,1))); ?></div>
      <div><div class="sb-un"><?php echo e(auth()->user()->nama_lengkap ?? auth()->user()->username); ?></div><div class="sb-ur">Administrator</div></div>
    </div>
    <form method="POST" action="<?php echo e(route('logout')); ?>"><?php echo csrf_field(); ?><button type="submit" class="sb-out">⬡ Keluar dari Sistem</button></form>
  </div>
</aside>
<main class="main">
  <div class="topbar">
    <div><div class="pg-t"><?php echo $__env->yieldContent('title','Dashboard'); ?></div><div class="pg-s"><?php echo $__env->yieldContent('breadcrumb','BrewLux POS'); ?></div></div>
    <span class="tb-d"><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></span>
  </div>
  <div class="cnt">
    <?php if(session('success')): ?><div class="alert al-s">✓ <?php echo e(session('success')); ?></div><?php endif; ?>
    <?php if(session('error')): ?><div class="alert al-e">✕ <?php echo e(session('error')); ?></div><?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\brewlux-pos\brewlux-pos\resources\views/layouts/admin.blade.php ENDPATH**/ ?>