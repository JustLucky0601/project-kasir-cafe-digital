...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;flex-wrap:wrap;gap:.75rem">
  <?php if(session()->has('tersedia_saved')): ?>
  <div style="color:var(--muted);font-size:.9rem">Nilai `tersedia` disimpan: <strong><?php echo e(session('tersedia_saved') ? 'true' : 'false'); ?></strong></div>
  <?php endif; ?>
